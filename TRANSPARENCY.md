...
## 4. Status Soft Launch

| Parameter | Detail |
| :--- | :--- |
| **Fase** | 2.6 — Soft Launch |
| **Kondisi** | Token ELR sudah hidup di BSC Mainnet. Likuiditas tersedia di PancakeSwap. |
| **Pengumuman Publik** | 🔒 Ditunda hingga 30 Genesis Witness tercapai. |
| **Airdrop ke Genesis Witness** | 🔒 Ditunda hingga 30 alamat GW terverifikasi. |

---

## 5. Komitmen Selanjutnya

- [x] Deploy token ELR ke BSC Mainnet
- [x] Distribusi token ke 5 alamat alokasi
